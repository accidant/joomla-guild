			...
			<td class="kcol-mid">
				<div id="kattachment-id" class="kattachment">
					...
					<div class="kfile-hide hasTip" title="<?php echo JText::_('COM_KUNENA_FILE_EXTENSIONS_ALLOWED')?>::<?php echo $this->escape(implode(', ', $this->allowedExtensions)) ?>" >
						<input type="button" value="<?php echo  JText::_('COM_KUNENA_EDITOR_ADD_FILE'); ?>" onclick="openFileUpload(this);" class="kfile-input-button kbutton" />
...
<script type="text/javascript">
	(function($){
		...
		openFileUpload = function($this){
			$($this).next('.kfile-input').click();
		}
	})(jQuery);
</script>
<?php
