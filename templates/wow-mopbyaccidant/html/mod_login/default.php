...
<div class="right-box">
	...
	<div class="header">
		...
		<?php if ($params->get('greeting')) : ?>
			...
			<div class="wow-chars">
				<?php
					$module = JModuleHelper::getModule("mod_wowchars");
					echo JModuleHelper::renderModule($module, array("test" => "blubb"));
				?>
			</div>
		<?php endif; ?>
			<div>
				<a href="<?php echo JRoute::_("index.php?option=com_users&view=profile"); ?>">Mein Profil</a>
			</div>
